...
@section('content')
  <div class="card card-success card-solid">
    <div class="card-header">
      <h3 class="card-title">{{ __('dotenv-editor::views.title') }}</h3>
        ...
        <div class="col-md-12">
          <ul class="nav nav-tabs">
            <li v-for="view in views" role="presentation" class=" nav-item ">
              <a href="javascript:;" class="nav-link @{{ view.active ? 'active' : '' }}"
                 @click="setActiveView(view.name)">@{{ view.name }}</a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <div class="panel-body">
                ...
                <p>
                  <a href="javascript:;" v-show="loadButton" class="btn btn-primary" @click="loadEnv">
                    {{ __('dotenv-editor::views.overview_table_key') }}
...
@endsection
@push('css')
  <link rel="stylesheet" href="{{asset('vendor/dotenv-editor/css/glyphicons.css')}}"/>
@endpush
@push('js')
  <script src="//cdn.staticfile.org/vue/1.0.20/vue.js"></script>
  <script>
    new Vue({
      el: '#app',
      data: {
